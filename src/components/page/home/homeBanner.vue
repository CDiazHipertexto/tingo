<template lang="pug">
  div#sectionBanner
    ...
    vueper-slides.slide-image-inside(
      ...
      :transitionSpeed='600',
      prevent-y-scroll)
      vueper-slide(v-for='(slide, i) in slides', :key='slide.id', :title='slide.title', :content='slide.content', :image="slide.image")
                        ...
                        b-col(sm='9', md='9', lg='9', xl='9')
                          div.wrapper-post
                            ...
                            div.content-perfil
                              ...
                              p.user-post De modo Juernes 🔥
                          div.wrapper-post
                            div.img
                              img.avatar(src='@/assets/user-maria.png', alt='up', width='30px')
                            div.content-perfil
                              p.user-name @arbolito
...
<style lang="sass">
    ...
    .wysiwyg
        ...
        button
            ...
            border-color: $OrangeHex //!important
            display: block
            font-weight: 500
